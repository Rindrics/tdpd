...
class Stock:
    ...
    def get_crossover_signal(self, on_date):
        ...
        try:
            long_term_ma_value = long_term_ma._value_on(on_date)
            prev_long_term_ma_value = long_term_ma._value_on(on_date - timedelta(1))
            short_term_ma_value = short_term_ma._value_on(on_date)
            prev_short_term_ma_value = short_term_ma._value_on(on_date - timedelta(1))
